...
export const SelectInputSettings = () => {
    const {
        actions: { setProp },
        props,
    } = useNode((node) => ({
    ...
    const ChangeMultipleValidationData = (Type, value) => {
        if(!value){
            setProp((props) => ( delete props.validation[Type]), 12);
            setProp((props) => ( delete props.validation['max']), 12);
            setProp((props) => ( delete props.validation['min']), 12);
            return;
        }
        setProp((props) => (props.validation[Type] = value), 12);
    }
                                    ...
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend >
                                            <InputGroup.Checkbox
                                                ...
                                                onChange={(e) => {
                                                    ChangeMultipleValidationData(e.target.name,e.target.checked);
                                                }}/>
                                            <InputGroup.Text className={'input_group_end'}>Multiple</InputGroup.Text>
                                        </InputGroup.Prepend>
                                    </InputGroup>
                                    {props.validation.multiple &&
                                    <>
                                        <InputGroup className="mb-3">
                                            <InputGroup.Prepend>
                                            ...
                                            <FormControl
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setProp((props) => (props.validation.max = e.target.value), 12);
                                                }}/>
                                        </InputGroup>
                                        <InputGroup className="mb-3">
                                            <InputGroup.Prepend>
                                            ...
                                            <FormControl
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setProp((props) => (props.validation.min = e.target.value), 12);
                                                }}/>
                                        </InputGroup>
                                    </>}
