...
export const ImageUploadSettings = () => {
    ...
    const ChangeWrapperColVal = (e, Size, Type) => {
        if(e.target.value < 0 || e.target.value > 12){
            if(e.target.value < 0){
                setProp((props) => (props.imagesAreaCol[Size][Type] = ''), 12)
            }
            e.preventDefault();
            return
        }
        setProp((props) => (props.imagesAreaCol[Size][Type] = e.target.value), 12)
    }


    const ChangeImageColVal = (e, Size, Type) => {
        if(e.target.value < 0 || e.target.value > 12){
            if(e.target.value < 0){
                setProp((props) => (props.imageCol[Size][Type] = ''), 12)
            }
            e.preventDefault();
            return
        }
        setProp((props) => (props.imageCol[Size][Type] = e.target.value), 12)
    }
            ...
            <Row>
                <Col xs={12}>
                    <Accordion defaultActiveKey={'main_info'}>
                        <Card>
                            ...
                            <Accordion.Collapse eventKey="main_info">
                                <Card.Body>
                                    ...
                                    <Col xs={12}>
                                        <Form.Group controlId="InputLabel">
                                            <Form.Label>Upload label</Form.Label>
                                            <Form.Control
                                                type="text"
                                                placeholder="label"
                                                value={(props.uploadLabel == '$Label' ? '' : props.uploadLabel)}
                                                onChange={(e) => {
                                                    if(!e.target.value){
                                                        setProp((props) => (props.uploadLabel = '$Label'), 12)
                                                        e.preventDefault()
                                                        return;
                                                    }
                                                    setProp((props) => (props.uploadLabel = e.target.value), 12)
                                                }}
                                            />
                                        </Form.Group>
                                    </Col>
                                    <Col xs={12}>
                                        <Form.Group controlId="InputLabel">
                                            ...
                                            <Form.Control
                                                type="text"
                                                placeholder="label"
                                                value={(props.changeLabel == '$Label' ? '' : props.changeLabel)}
                                                onChange={(e) => {
                                                    if(!e.target.value){
                                                        setProp((props) => (props.changeLabel = '$Label'), 12)
                                                        e.preventDefault()
                                                        return;
                                                    }
                                                    setProp((props) => (props.changeLabel = e.target.value), 12)
                                                }}
                                            />
                                        </Form.Group>
                                    </Col>
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="images_area">
                                    Images Area
                                </Accordion.Toggle>
                            </Card.Header>
                            <Accordion.Collapse eventKey="images_area">
                                <Card.Body>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend>
                                            <InputGroup.Text>xs</InputGroup.Text>
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.xs.span}
                                                     onChange={(e) => {
                                                         ChangeWrapperColVal(e,'xs','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.xs.offset}
                                                     onChange={(e) => {
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.md.span}
                                                     onChange={(e) => {
                                                         ChangeWrapperColVal(e,'md','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.md.offset}
                                                     onChange={(e) => {
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.lg.span}
                                                     onChange={(e) => {
                                                         ChangeWrapperColVal(e,'lg','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.lg.offset}
                                                     onChange={(e) => {
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.xl.span}
                                                     onChange={(e) => {
                                                         ChangeWrapperColVal(e,'xl','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imagesAreaCol.xl.offset}
                                                     onChange={(e) => {
                        ...
                        <Card>
                            <Card.Header>
                                <Accordion.Toggle as={Button} variant="link" eventKey="image_size">
                                    Image Size
                                </Accordion.Toggle>
                            </Card.Header>
                            <Accordion.Collapse eventKey="image_size">
                                <Card.Body>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend>
                                            <InputGroup.Text>xs</InputGroup.Text>
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imageCol.xs.span}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'xs','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imageCol.xs.offset}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'xs','offset')
                                                     }}
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imageCol.md.span}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'md','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imageCol.md.offset}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'md','offset')
                                                     }}
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imageCol.lg.span}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'lg','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imageCol.lg.offset}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'lg','offset')
                                                     }}
                                    ...
                                    <InputGroup className="mb-3">
                                        ...
                                        <FormControl type={'number'}
                                                     value={props.imageCol.xl.span}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'xl','span')
                                                     }}
                                        />
                                        <FormControl type={'number'}
                                                     value={props.imageCol.xl.offset}
                                                     onChange={(e) => {
                                                         ChangeImageColVal(e,'xl','offset')
                                                     }}
                                ...
                                <Card.Body>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend >
                                            <InputGroup.Checkbox
                                                name={'multiple'}
                                                checked={props.validation.multiple}
                                                onChange={(e) => {
                                                    ChangeValidationData(e.target.name,e.target.checked);
                                                }}/>
                                            <InputGroup.Text className={'input_group_end'}>multiple</InputGroup.Text>
                                        </InputGroup.Prepend>
                                    </InputGroup>
                                    <InputGroup className="mb-3">
                                        <InputGroup.Prepend >
