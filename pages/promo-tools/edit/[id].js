...
export default function EditGameProperty ({GameData}){
   ...
   const ChangeButtonInputCheck = (e) =>{
    ...
    const SubmitData = (formData) =>{
        let url = GetApiUrl("promo-tools/" + GameData.data.id +'?_method=PUT');
        ...
        <Card className={'custom-card mt-3'}>
            ...
            <BootstrapForm id={"example-form"} itemRef={$bootstrapFormRef} onSubmit={OnFormSubmit}>
                ...
                >
                    <Card.Body>
                        ...
                        <Col
                            ...
                            <FormGroup required
                                       max={12}
                                       min={1}
                                       $defaultValue={GameData.data.col}
                                       name={'col'}
                                       label={'View Col'}
                                       onChange={SetFormDataValue}
                                       wrapperCol={{
                    ...
                    <Card.Footer>
                        <FormGroup >
                            <FormControl  className={'btn btn-primary btn-submit d-flex justify-content-center'} type="submit" />
                        </FormGroup>
...
export async function getServerSideProps({params}){
    let url = GetApiUrl("promo-tools/"+params.id);
